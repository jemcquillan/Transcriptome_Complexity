...
#setwd("/Volumes/GoogleDrive/My Drive/OrthoDB/Ortholog_Final_Files/Plantae_Complexity/")
setwd("<your path here>")

# Creates a list of files from the directory that has the appropriate metrics of novel genes
novel_EpT <- list.files('plantae_complexity_stats/plantae_novel_genes/plantae_novel_EpT/')
novel_TpG_EpG <- list.files('plantae_complexity_stats/plantae_novel_genes/plantae_novel_TpG_EpG/')

# Creates a list of files from the directory that has the appropriate metrics of orthologs
ortho_EpT <- list.files('plantae_complexity_stats/plantae_ortholog/plantae_ortholog_EpT/')
ortho_TpG_EpG <- list.files('plantae_complexity_stats/plantae_ortholog/plantae_ortholog_TpG_EpG/')

# Creates a list of files from the directory that has the appropriate metrics of whole transcriptomes
wt_EpT <- list.files('plantae_complexity_stats/plantae_whole_genome/plantae_whole_genome_EpT/')
wt_TpG_EpG <- list.files('plantae_complexity_stats/plantae_whole_genome/plantae_whole_genome_TpG_EpG/')
...
output_directory <- "<your path here> /plantae_complexity_stats/plantae_density_plots"
...
for(i in 1:length(ortho_EpT)){
  ...
  ortho_EpT_df <- read.csv(file.path('plantae_complexity_stats/plantae_ortholog/plantae_ortholog_EpT/',ortho_EpT[i]), sep = ',')
  ...
  ortho_TpG_EpG_df <- read.csv(file.path('plantae_complexity_stats/plantae_ortholog/plantae_ortholog_TpG_EpG/',ortho_TpG_EpG[i]), sep = ',')
  ...
  wt_EpT_df <- read.csv(file.path('plantae_complexity_stats/plantae_whole_genome/plantae_whole_genome_EpT/',wt_EpT[i]), sep = ',')
  wt_EpT_df$group <- 'whole transcriptome'
  
  wt_TpG_EpG_df <- read.csv(file.path('plantae_complexity_stats/plantae_whole_genome/plantae_whole_genome_TpG_EpG/',wt_TpG_EpG[i]), sep = ',')
  ...
  novel_EpT_df <- read.csv(file.path('plantae_complexity_stats/plantae_novel_genes/plantae_novel_EpT/',novel_EpT[i]), sep = ',')
  # This creates and appends a column names group, and labels the orthologs 'ortho'
  ...
  # Same this here as above. Creates a data frame with all the data, and adds column group
  # labeled ortho for all the orthologs for the other 2 metrics
  novel_TpG_EpG_df <- read.csv(file.path('plantae_complexity_stats/plantae_novel_genes/plantae_novel_TpG_EpG/',novel_TpG_EpG[i]), sep = ',')
...
pdf(paste0(output_directory,'/Plantae_EpT_plot_novel_trunc.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_novel_EpT_trunc[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpT_plot_novel.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_novel_EpT[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_TpG_plot_novel_trunc.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_novel_TpG_trunc[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_TpG_plot_novel.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_novel_TpG[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpG_plot_novel_trunc.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_novel_EpG_trunc[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpG_plot_novel.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
...
pdf(paste0(output_directory,'/Plantae_EpT_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_EpT[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpG_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_EpG[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_TpG_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_TpG[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpT_truncated_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_EpT_trunc[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_EpG_truncated_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
  print(plot_EpG_trunc[[i]])
}
dev.off()

pdf(paste0(output_directory,'/Plantae_TpG_truncated_plot_wilcoxon.pdf'),7,5)
for(i in 1:length(ortho_EpT)){
